...
export const metadata: Metadata = {
  ...
  description:
    'Politique de confidentialite du site ACBIM : formulaire de contact, audience, contenus tiers, durees de conservation et droits RGPD.',
  alternates: {
    canonical: '/politique-confidentialite/',
  },
  openGraph: {
    title: `Politique de confidentialite | ${COMPANY_NAME}`,
    description: 'Traitements de donnees personnelles realises via le site ACBIM.',
    type: 'website',
...
const processingRows = [
  {
    purpose: 'Repondre aux demandes envoyees via le formulaire, par email ou par telephone',
    data: 'Nom, email, telephone si communique, sujet, message, informations de projet',
    basis: 'Mesures precontractuelles et interet legitime',
  },
  {
    purpose: 'Assurer le suivi commercial ou technique d une demande professionnelle',
    data: 'Coordonnees, historique des echanges, pieces utiles au projet',
    basis: 'Interet legitime ou execution d un contrat',
  },
  {
  ...
  {
    purpose: 'Mesurer l audience du site avec Google Analytics apres consentement',
    data: 'Pages consultees, evenements de navigation, identifiants de mesure, donnees techniques de visite',
    basis: 'Consentement',
  },
]
...
export default function PrivacyPolicyPage() {
  ...
  return (
    <>
      ...
      <LegalPageShell
        title="Politique de confidentialite"
        description="Cette page explique quelles donnees sont traitees via le site, pourquoi, pendant combien de temps et comment exercer vos droits."
        updatedAt="23 avril 2026"
      >
        <section>
          <h2 className="text-2xl font-bold text-slate-950">Responsable du traitement</h2>
          <p className="mt-4">
            Le responsable du traitement est {COMPANY_LEGAL_NAME}, editeur du site {COMPANY_NAME}. Pour toute question
            relative aux donnees personnelles, vous pouvez ecrire a{' '}
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-950">Traitements realises</h2>
        ...
        <section>
          ...
          <p className="mt-4">
            Les champs obligatoires du formulaire servent uniquement a comprendre votre demande et a vous repondre. Le
            formulaire archive aussi des donnees techniques limitees afin de securiser le service, diagnostiquer une
            erreur d envoi et limiter les abus. Ces donnees ne sont pas revendues.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4">
            Les donnees sont accessibles aux personnes habilitees chez ACBIM et, lorsque cela est necessaire, a ses
            prestataires techniques : Cloudflare pour l hebergement statique, OVH pour l endpoint du formulaire,
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            peut alors recevoir votre adresse IP, votre user-agent, la page d origine, des donnees techniques de
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-950">Durees de conservation</h2>
          <ul className="mt-4 list-disc space-y-3 pl-5">
            <li>Demandes de contact : temps necessaire au traitement, puis jusqu a 3 ans apres le dernier echange.</li>
            <li>Documents lies a une mission ou un contrat : duree de la relation puis durees legales applicables.</li>
            <li>Journaux techniques du formulaire : jusqu a 12 mois, sauf besoin de securite ou contentieux.</li>
            <li>Choix cookies : 6 mois avant une nouvelle demande de choix.</li>
            <li>Cookies Google Analytics : duree maximale configuree a 13 mois.</li>
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            {' '}avec l objet &quot;Donnees personnelles&quot;. En cas de difficulte non resolue, vous pouvez saisir la CNIL.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-4">
            ...
            l audience. Certaines pages peuvent aussi charger des contenus tiers Google ou Matterport. Le detail et les
