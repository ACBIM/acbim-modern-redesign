...
const FILTER_ALIASES: Record<string, string[]> = {
  ...
  drone: ['drone', 'photogrammétrie', 'vues aeriennes'],
  'plans 2d': ['plans 2d', 'plan', 'coupes', 'élévations', 'dwg', 'pdf'],
  bim: ['bim', 'maquette bim', 'maquette numérique 3d', 'revit', 'ifc'],
  ...
  'audit energetique': ['audit énergétique', 'actee'],
  "plan d'interieur": ['plans 2d', 'plan', 'coupes', 'élévations', 'intérieur', 'piece'],
  numerisation: ['numérisation', 'scan 3d', 'nuage de points', 'photogrammétrie', 'orthophoto', 'georeferencement'],
  geometre: ['topographie', 'georeferencement', 'plans 2d', 'relevé'],
  topographie: ['topographie', 'georeferencement'],
  'maquette 3d': ['maquette 3d', 'maquette bim', 'maquette numérique 3d', 'revit', 'ifc'],
  modelisation: ['modélisation', 'maquette', 'revit', 'bim'],
}
