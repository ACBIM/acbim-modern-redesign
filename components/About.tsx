        ...
        <div className="flex flex-col items-center gap-12 lg:flex-row">
          ...
          <div className="lg:w-1/2">
            ...
            <p className="mt-6 leading-relaxed text-slate-600">
              Fondé en 2017 a Aurillac, ACBIM est un bureau d&apos;études techniques spécialisé dans les relevés 3D,
              relevés par drone, la maquette numérique 3D et la topographie. Nous nous positionnons comme un acteur
              engage de la transition numérique et écologique du bâtiment, en fournissant des données fiables et
              exploitables pour les collectivités, architectes, industriels et gestionnaires de patrimoine.
            </p>

            <p className="mt-4 leading-relaxed text-slate-600">
              Notre équipe pluridisciplinaire de 5 experts utilise des technologies de pointe (scanner laser, drone, GPS
              RTK) pour répondre avec précision à vos besoins sur des projets de rénovation, de gestion patrimoniale ou
