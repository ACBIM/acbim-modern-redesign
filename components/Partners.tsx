...
const PARTNERS = [
  {
    ...
    description:
      "La société ACDEAU, basee a Aurillac dans le Cantal et creee en 2010, propose ses services dans les domaines de l'alimentation en eau potable et de l'assainissement.",
  },
  {
    ...
    description:
      "2B Maitrise & Concept concilie 15 ans d'experience en maitrise d'oeuvre et 15 ans de terrain en travaux publics, en liant conception et réalisation.",
  },
  {
    name: 'EREAH',
    ...
    description:
      "EREAH est un bureau d'études d'ingenierie fluides, thermique et énergie dans le domaine du bâtiment.",
  },
  {
    name: 'EnerBIM',
    ...
    description:
      "EnerBIM accompagne les professionnels dans la transition numérique et developpe des solutions innovantes pour le bâtiment, l'énergie et l'interoperabilite BIM.",
  },
]
      ...
      <div className="container mx-auto px-6">
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto mt-4 max-w-3xl text-lg text-slate-600">
            Nous collaborons avec des structures complémentaires pour proposer une approche complete, du terrain aux
